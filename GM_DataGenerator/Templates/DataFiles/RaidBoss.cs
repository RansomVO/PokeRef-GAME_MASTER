...
namespace VanOrman.PokemonGO.GAME_MASTER.DataGenerator.Templates.DataFiles
{
    ...
    public class RaidBoss
    {
        ...
        public RaidBoss(RaidBosses._RaidBoss raidboss, Common.IVScore baseIV, Common.PossibilitySet.Possibility[] regular, Common.PossibilitySet.Possibility[] boosted)
        {
        ...
        public static void Write(RaidBosses raidBosses, GameMasterStatsCalculator gameMasterStatsCalculator)
        {
                ...
                projLastUpdated < gameMasterStatsCalculator.GameMasterStats.last_updated.Date)
            {
                using (TextWriter projWriter = new StreamWriter(ProjFilePath))
                {
                    ...
                    projWriter.WriteLine("  <!-- ===================== (last_updated=\"" + DateTime.Today.ToString(PokeConstants.DateFormat) + "\") ===================== --> ");
                    projWriter.WriteLine("  <!-- ======================================================================= -->");
        ...
        private static bool WriteRaidBoss(RaidBosses._RaidBoss raidboss, DateTime raidbossesLastUpdated, DateTime gameMasterLastUpdated)
        {
            bool upToDate = true;
            string raidbossFileName = GetFileNameBase(raidboss);
            ...
            if (!File.Exists(filePath) ||
                lastUpdated < raidbossesLastUpdated ||
                lastUpdated < gameMasterLastUpdated)
            {
                ...
                Utils.WriteXML(new RaidBoss(raidboss, baseIV, Utils.GetEncounterPossibilities(raidboss.PokemonTranslator, 20), Utils.GetEncounterPossibilities(raidboss.PokemonTranslator, 25)), filePath);
				upToDate = false;
            }
